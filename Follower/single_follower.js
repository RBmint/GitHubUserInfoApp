...
/**
 * Renders the follower card in the profile page.
 * @param {*} param0 a list of items
 * @returns the follower card
 */
function SingleFollower  ({ containerStyle, avatarUrl, name, username }) {
